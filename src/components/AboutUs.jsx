        ...
        <section id="about" ref={sectionRef} className="w-full py-24 px-4 bg-gradient-to-b from-black to-[#0a0a0a] text-white overflow-hidden relative">
            ...
            <motion.div className="container mx-auto max-w-6xl relative z-10" initial="hidden" animate={isInView ? "visible" : "hidden"} variants={containerVariants}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto mb-16 text-left">
                    ...
                    <motion.div className="space-y-6" variants={itemVariants}>
                        ...
                        <ul className="space-y-5 text-gray-400">
                            ...
                            <li className="flex gap-4 items-start group">
                                <ArrowRight className="w-5 h-5 text-purple-500 shrink-0 mt-0.5 transition-transform group-hover:translate-x-1" />
                                <span className="leading-relaxed"><strong>Technical Lead</strong> at Google Developer Groups (GDG) - Presidency University. Orchestrated 5+ workshops and hackathons across Web, Cloud, and AI/ML tracks for a chapter of 20+ developers.</span>
                            </li>
                            <li className="flex gap-4 items-start group">
                                <ArrowRight className="w-5 h-5 text-purple-500 shrink-0 mt-0.5 transition-transform group-hover:translate-x-1" />
                            ...
                            <li className="flex gap-4 items-start group">
                                <ArrowRight className="w-5 h-5 text-purple-500 shrink-0 mt-0.5 transition-transform group-hover:translate-x-1" />
                                <span className="leading-relaxed"><strong>Software Development Intern</strong> at Pinnacle Labs. Accelerated feature delivery by 25% by architecting RESTful API modules and seamlessly integrating them with the React frontend.</span>
                            </li>
                        </ul>
                    </motion.div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-4">
                                <div className="bg-gray-900/40 border border-gray-800 p-5 rounded-xl hover:border-purple-500/30 transition-colors">
                                    <div className="font-bold text-white text-lg">B.Tech in Computer Science</div>
                                    <div className="text-purple-400 text-sm mb-3 font-medium">Presidency University, Bangalore • Oct 2023 — Jun 2027 • CGPA: 8.52</div>
                                ...
                                <div className="bg-gray-900/40 border border-gray-800 p-5 rounded-xl hover:border-purple-500/30 transition-colors">
                                    <div className="font-bold text-white text-lg">Class XII</div>
                                    <div className="text-purple-400 text-sm mb-2 font-medium">St. Joseph Pre-University College, Bangalore • Sep 2021 — Mar 2023</div>
                                    <p className="text-sm text-gray-500 leading-relaxed">Senior Secondary Education — 82.4%</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
                ...
                <motion.div className="flex justify-center mb-24" variants={itemVariants}>
                    <a href="#projects" className="bg-white text-black hover:bg-gray-200 px-8 py-3 rounded-full flex items-center gap-2 font-semibold transition-transform hover:scale-105 shadow-[0_0_20px_rgba(255,255,255,0.1)]">
