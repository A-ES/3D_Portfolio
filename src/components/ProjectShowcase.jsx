...
const projects = [
    {
        title: "Feedback-to-Code Automation System",
        description: "Eliminated 40% of manual code-update effort by engineering an end-to-end pipeline that converts raw user feedback into committed code with zero human handoff. Reduced cycle from hours to under 10 minutes.",
        year: "2025",
        link: "#",
    ...
    },
    {
        ...
        description: "Delivered a full-stack platform automating funding-eligibility scoring for 100+ structured startup records. Built an analytics dashboard surfacing actionable KPIs from multi-dimensional datasets.",
        year: "2025",
        link: "#",
