...
const footerLinks = [
  ...
  },
  {
    label: 'Connect',
    links: [
      { title: 'GitHub', href: 'https://github.com/A-ES', icon: Globe },
      { title: 'LinkedIn', href: 'https://www.linkedin.com/in/mohammed-abrar-ba0222304/', icon: Briefcase },
      { title: 'Email Me', href: 'mailto:mohammedabrar934@gmail.com', icon: Mail },
    ],
  },
];
      ...
      <div className="max-w-6xl mx-auto grid w-full gap-12 xl:grid-cols-4 xl:gap-8">
        <AnimatedContainer className="space-y-4 xl:col-span-2">
          ...
          <p className="text-gray-400 text-sm max-w-sm leading-relaxed">
            Full Stack Developer crafting fast, pixel-perfect web experiences. Based in Bangalore, open to the world.
          </p>
          <p className="text-gray-600 text-sm pt-6">
            © {new Date().getFullYear()} Mohammed Abrar.
          </p>
        </AnimatedContainer>
